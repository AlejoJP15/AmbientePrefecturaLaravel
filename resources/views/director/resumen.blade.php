    ...
    <div class="main-container">
        <div class="archivo-wrapper">
            <div class="soca-container">
                ...
                <form method="POST"
                    action="{{ route('director.obligaciones.dictamen.update', $obligacion->id_obligacion) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="decision-section">
                        ...
                        <p class="decision-text">
                            ¿El proyecto cumple los criterios administrativos para su aprobación final?
                        </p>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const validarUrl = `{{ route('director.obligaciones.firma.validar', $obligacion->id_obligacion) }}`;
