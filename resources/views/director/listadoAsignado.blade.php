                ...
                <div class="table-responsive">
                    <table id="obligacionesTable" class="table table-striped table-hover w-100">
                        ...
                        <tbody>
                            @php
                                $contador = 0;
                                $obligacionesFiltradas = $obligaciones->filter(function ($obl) {
                                    return $obl->id_estado_proyecto == 2;
                                });
                            @endphp

                            @if ($obligacionesFiltradas->count() > 0)
                                @foreach ($obligacionesFiltradas as $obl)
                                    @php $contador++; @endphp
                                    <tr>
                                        <td>{{ $contador }}</td>
                                        <td>
