...
<head>
  ...
  <title>SCCA — Director</title>
</head>
<body>
  <div class="main-container">

    <!-- MENÚ LATERAL (Director) -->
    <div class="sidebar">
      <div class="logo">
      ...
      <ul class="menu-vertical">
        ...
        <li class="submenu">
          <a href="#">
            <i class="fa-solid fa-file-circle-check"></i>
            <span>Proyectos aprobados por coordinador</span>
            <span class="flecha"><i class="fas fa-angle-down"></i></span>
          </a>
          <ul class="submenu-items">
            <li>
              <a href="{{ route('director.obligaciones.aprobados') }}">
    ...
    <div class="contenido">
      <div class="perfil">
        <button type="button" class="perfil-btn">Director ▼</button>
