    ...
    <div class="main-container">
        <div class="container-fluid py-4">
            <div class="bg-white rounded shadow-sm p-4">
                <h2 class="mb-3 text-center">Listado de Obligaciones</h2>
                        ...
                        <tbody>
                            ...
                            @forelse ($obligaciones as $obl)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $obl->estado_asignacion ?? '—' }}</td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center">Sin datos.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        $(document).ready(function() {
            @if ($obligaciones->isNotEmpty())
                $('#obligacionesTable').DataTable({
                    ...
                    pageLength: 10,
                    order: [[6, 'asc']], // Ordenar por "Estado Asignación"
                    columnDefs: [{
                        orderable: false,
