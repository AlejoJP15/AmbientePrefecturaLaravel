    ...
    <div class="main-container">
        <div class="container-fluid py-4">
            <div class="bg-white rounded shadow-sm p-4">
                <h2 class="mb-3 text-center">Proyectos aprobados por el técnico</h2>
                ...
                <div class="table-responsive">
                    <table id="obligacionesTable" class="table table-striped table-hover w-100">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center">No hay proyectos aprobados por el técnico.</td>
