{{-- resources/views/menu_general/menu_general_coordinador.blade.php --}}
...
<header class="header">
    <div class="logo-header"><img src="{{ asset('img/logo1.jpg') }}" alt="Logo" /></div>
    <div class="header-title">
        <h3>SOACH - Sistema de Obligaciones Ambientales - HGADPCH</h3>
    </div>
    <div class="header-right">
        <a href="{{ route('coordinador.dashboard') }}" class="home-button" title="Volver al menú principal">
...
<nav class="menu-horizontal">
    <ul class="mh">
        ...
        <!-- 1) PROYECTOS APROBADOS-> Listado -->
                <li class="submenu">
                <a href="#" class="submenu-toggle"> <!-- ← agrega esta clase -->
                    <i class="fa-solid fa-file-circle-check"></i>
