            ...
            <form id="formPlantilla" method="POST">
                ...
                <div class="editor-section">
                    ...
                    <textarea id="asunto-editor" name="asunto" class="tiny-editor">
                        {!! $plantilla->asunto ?? '<div class="template-variable"><p>ASUNTO: OBSERVACIONES AL <span class="variable"><strong>[tipoObligacion]</strong></span> DEL PROYECTO "<span class="variable"><strong>[nombreProyecto]</strong></span>" PERIODO <span class="variable"><strong>[periodo]</strong></span></p></div>' !!}
                    </textarea>
                </div>
                ...
                <div class="editor-section">
                    ...
                    <textarea id="cuerpo-editor" name="cuerpo" class="tiny-editor">
                        {!! $plantilla->cuerpo ?? '<div class="template-text"><p><span class="variable"><strong>[antecedentes]</strong></span></p><p>Al respecto, una vez realizado el análisis correspondiente y sobre la base del <span class="variable"><strong>[numeroInforme]</strong></span> del <span class="variable"><strong>[fechaInforme]</strong></span>, remitido mediante MEMORANDO <span class="variable"><strong>[numeroMemo]</strong></span> del <span class="variable"><strong>[fechaMemo]</strong></span>, se determina que la información que consta en <span class="variable"><strong>[tipoObligacion]</strong></span> del Proyecto "<span class="variable"><strong>[nombreProyecto]</strong></span>", <span class="variable"><strong>[valorCumple]</strong></span> con los requerimientos establecidos en la Normativa Ambiental Vigente por lo que esta Dependencia Administrativa <span class="variable"><strong>[valorAcepta]</strong></span> el <span class="variable"><strong>[tipoObligacion]</strong></span>, se solicita se realicen las modificaciones a las observaciones realizadas a la documentación presentada conforme al siguiente detalle:</p><p><span class="variable"><strong>[detalle]</strong></span></p><p>Esta información deberá ser presentada en un plazo no mayor a los 20 DÍAS a partir de su notificación conforme a lo establecido en el Reglamento al Código Orgánico del Ambiente, Art. 516 respuesta a las notificaciones a la Autoridad Ambiental, a través de la siguiente página web <a href="https://www.ambiente.chimborazo.gob.ec" target="_blank">www.ambiente.chimborazo.gob.ec</a>, en el link del sistema de control y calidad ambiental, de la Prefectura de Chimborazo.</p></div>' !!}
                    </textarea>
                </div>
