...
<head>
    ...
    <title>Editor de Memo pronunciamiento favorable</title>
...
<div class="main-container">
    ...
    <div class="page-wrapper">
        <div class="editor-container">
            <h1>Edición de la Plantilla para Memo Pronunciamiento Favorable</h1>
            ...
            <form id="formPlantilla" method="POST">
                ...
                <div class="editor-section">
                    ...
                    <textarea id="para-editor" name="para" class="tiny-editor">
                        {!! $plantilla->para ?? '<div class="template-variable"><p>MSc. Manuel Saúl Orellana Fierro <br><br><strong>DIRECTOR GENERAL DE GESTIÓN AMBIENTAL</strong></p></div>' !!}
                    </textarea>
                </div>
                ...
                <div class="editor-section">
                    ...
                    <textarea id="asunto-editor" name="asunto" class="tiny-editor">
                        {!! $plantilla->asunto ?? '<div class="template-variable"><p>Pronunciamiento favorable al <span class="variable"><strong>[tipoObligacion]</strong></span> del proyecto "<span class="variable"><strong>[nombreProyecto]</strong></span>" período <span class="variable"><strong>[periodo]</strong></span>, <span class="variable"><strong>[numeroInforme]</strong></span></p></div>' !!}
                    </textarea>
                </div>
