            ...
            <form id="formPlantilla" method="POST">
                ...
                <div class="editor-section">
                    ...
                    <textarea id="asunto-editor" name="asunto" class="tiny-editor">
                        {!! $plantilla->asunto ?? '<div class="template-variable"><p><strong>ASUNTO:</strong> APROBACIÓN AL <span class="variable"><strong>[tipoObligacion]</strong></span> DEL PROYECTO "<span class="variable"><strong>[nombreProyecto]</strong></span>" PERIODO <span class="variable"><strong>[periodo]</strong></span>, <span class="variable"><strong>[numeroInforme]</strong></span></p></div>' !!}
                    </textarea>
                </div>
